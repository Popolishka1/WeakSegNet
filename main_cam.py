...
# TODO (Paul): wrap up in classification.py
...
# TODO (Paul): wrap up in model.py (merge with the other function in baseline.py)
...
def main():
    ...
    visualize_cams(classifier=classifier, test_loader=test_loader, device=device, cam_threshold=cam_threshold, save_path="cam_examples.png") # TODO (Paul): add saving path in cfg
